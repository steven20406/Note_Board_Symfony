...
class Version20171201025730 extends AbstractMigration {
    ...
    public function up(Schema $schema) {
        ...
        $this->addSql('CREATE TABLE transaction_list (id BIGINT AUTO_INCREMENT NOT NULL, amount BIGINT NOT NULL, at DATETIME NOT NULL, balance BIGINT NOT NULL, userId BIGINT DEFAULT NULL, INDEX IDX_723705D164B64DCC (userId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
